...
class EmailsSuperAdmin extends Controller
{
    //
    ...
    public function index(){
        ...
        return view('dashboard/emailssuperadmin', [
            'usuarios' => $usuarios,       
            'empresas' => $empresas,     
            'total' => $total,
    ...
    public function viewMail($id){
        ...
        return view('dashboard/editemailssuperadmin', [
            'correo' => $correo
        ]);
    }
    ...
    public function sendTestMail(Request $request){
        ...
        try{
            ...
            Mail::to(ltrim(Auth::user()->email))->send($mail);
        }catch(Exception $e){
            Log::error($e->getMessage());
