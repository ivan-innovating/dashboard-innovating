...
<div class="card">
	<div class="card-header">
		<h3 class="card-title">Usuarios sin empresa</h3>
        ...
        <div class="table-responsive">
            <table class="table table-hover text-nowrap f-14" style="overflow-x:scroll" id="table3">
                ...
                <tbody>
                    @if($usuarios->count() > 0)
                        @foreach($usuarios as $user)
                            ...
                            <tr>
                                ...
                                <td>{{ \Carbon\Carbon::parse($user->email_verified_at)->format('d/m/Y H:m:s')}}</td>
                    ...
                    @else
                    <tr>
                        <td colspan="7">No hay usuarios sin empresa</td>
                    </tr>
                    @endif
                </tbody>
            </table>
