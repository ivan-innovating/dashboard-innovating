...
<div class="card">
	<div class="card-header">
		<h3 class="card-title">Listado de patentes sin CIF</h3>
	...
	<div class="card-body">
		...
		<div class="tab-content">
            <div class="tab-pane active" id="patentes1">
                <div class="post">
                    <h2 class="font-semibold text-xl text-gray-800 leading-tight mb-3">
                        Patentes sin match: {{$patentessinmatch->count()}}
                    </h2>
                    <div class="row">
                        <div class="table-responsive">
                            <table class="table table-hover text-nowrap f-14" id="table1" style="overflow-x:scroll">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>Nombre</th>
                                ...
                                <tbody>
                                    @if($patentessinmatch->count() > 0)
                                        @foreach($patentessinmatch as $patente)
                                        <tr>
                                            <td>
