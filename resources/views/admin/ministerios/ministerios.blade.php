...
<div class="card">
	<div class="card-header">
		<h3 class="card-title">Listado de Ministerios</h3>
        ...
        <div class="table-responsive">        
            <table class="table table-hover text-nowrap f-14 w-100" id="table2">
                ...
                <tbody>
                    ...
                    <tr data-item="ministerio" id="ministerio{{$ministerio->id}}">
                        <td>
                            <button class="btn btn-sm btn-warning" onclick="copyContent('{{$ministerio->Nombre}}')" title="Copiar Id departamento"><i class="fa-regular fa-clipboard"></i></button> 
                        </td>
                        <td>
                            {{$ministerio->Nombre}}
                        </td>
