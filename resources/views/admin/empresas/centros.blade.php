...
<div class="card">
	<div class="card-header">
		<h3 class="card-title">Centros tecnológicos</h3>
			...
			<div class="table-responsive">
				<table class="table table-hover text-nowrap f-14" style="overflow-x:scroll" id="table2">
					...
					@if($empresas)
						...
						<tr id="{{$empresa->id}}">
							<td>
								<a href="{{route('viewempresa', [$empresa->id, $empresa->CIF])}}?page={{request()->get('page')}}" class="btn btn-primary btn-sm" title="Editar Centro"><i class="fas fa-edit"></i></a>
